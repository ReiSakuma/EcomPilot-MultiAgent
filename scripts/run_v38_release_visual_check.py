...
BASE_URL = os.getenv("ECOMPILOT_VISUAL_BASE_URL", "http://127.0.0.1:8239").rstrip("/")
OUTPUT_DIR = ROOT / "reports" / "browser" / "v38"
VIEWPORTS = {
        ...
        try:
            for name, viewport in VIEWPORTS.items():
                ...
                conversation_response = page.request.post(
                    ...
                    data={"title": f"V38 context visual {name}"},
                )
